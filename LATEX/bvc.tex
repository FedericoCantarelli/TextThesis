...
\begin{figure}
    \centering
    \subfloat[\label{fig:altezzabambine}]{
...
\begin{figure}
    \centering
    \subfloat[\label{fig:simulationprofile}]{\includegraphics[width=0.45\textwidth]{Images/simulation.png}}
    \quad
    \subfloat[\label{fig:time}]{\includegraphics[width = 0.45\textwidth]{Images/time.png}}
...
\begin{figure}
    \centering
    \subfloat[\label{fig:frames}]{\includegraphics[width = 0.5\textwidth]{Images/frames.png}}
    \quad
    \subfloat[\label{fig:risultati}]{\includegraphics[width = 0.5\textwidth]{Images/final_figure_1.png}}
...
The problem with \ref{eq:classrate} is that it is strongly biased in this case: since the defects are very small relative to the domain, the large number of pixels in control will significantly affect the $\operatorname{CLASS}$.
